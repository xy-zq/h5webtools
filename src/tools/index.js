...
XyTools.prototype = {
  ...
  FD(date, format = 0, symbol_date = '-', symbol_time = ':', type = 24) {
    ...
    type = parseInt(type) == 12 ? 12 : 24; // 24 小时格式
  ...
  /**
   * XR 封装的XMLHttpRequest
   * @param {*} option 
   * @returns 
   */
  async xyRequest(option) {
    class XyRequest {
      ...
      init() {
        ...
        this.XHR.send(this.METHOD === 'GET' ? null : JSON.stringify(this.PARAMS));
      }
